...
[![NeoForge](https://img.shields.io/badge/NeoForge-21.6.x-orange.svg)](https://neoforged.net/)
...
`anvillib-neoforge-1.21.6` is the aggregate artifact. It bundles and re-exports:
...
dependencies {
    ...
    implementation "dev.anvilcraft.lib:anvillib-codec-neoforge-1.21.6:2.0.0"
