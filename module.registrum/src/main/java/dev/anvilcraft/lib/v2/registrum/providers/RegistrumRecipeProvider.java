 ...
 *
 * Original File: https://github.com/IThundxr/Registrate/blob/1.21/dev/src/main/java/com/tterrag/registrate/providers/RegistrateRecipeProvider.java
 */
...
public class RegistrumRecipeProvider extends RecipeProvider implements RegistrumProvider, RecipeOutput {

    private final AbstractRegistrum<?> owner;
    @Getter
	private HolderLookup.Provider provider;

    public RegistrumRecipeProvider(AbstractRegistrum<?> owner, PackOutput output, CompletableFuture<HolderLookup.Provider> provider) {
