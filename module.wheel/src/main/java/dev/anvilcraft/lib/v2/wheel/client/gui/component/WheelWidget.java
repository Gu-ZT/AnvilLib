...
public class WheelWidget extends AbstractWidget {
    ...
    private void renderProgressAnimation(GuiGraphics guiGraphics, float progress) {
        ...
        if (this.currentSectionIndex != -1) {
            ...
            WheelWidget.renderSelectionEffect(guiGraphics, center.x, center.y, this.selectionEffectColor, this.selectionEffectRadius);
        }
        for (WheelSection value : this.sections) {
            Vector2f center = new Vector2f(
    ...
    private void renderSelection(GuiGraphics guiGraphics) {
        ...
        WheelWidget.renderSelectionEffect(guiGraphics, pos.x, pos.y, this.selectionEffectColor, this.selectionEffectRadius);
    }
